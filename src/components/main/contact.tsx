    ...
    <div id="Contact" className="w-full h-screen bg-transparent">
      <div className="max-w-[1000px] mx-auto px-4 flex flex-col justify-center items-center h-full text-white xsm:px-5">
        ...
        <div>
          ...
          <a href="mailto:your.email@example.com" className="flex justify-center bg-transparent text-white px-2 py-2 rounded-3xl ring-2 ring-blue-500 my-4 hover:scale-110 transition-all duration-1000 ease-in-out ">
            Email
          </a>
        </div>
      </div>
