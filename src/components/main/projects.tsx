        ...
        {projects.map((project) => (
          ...
          >
            <div className="relative h-60 overflow-hidden ">
              ...
              {project.featured && (
                <div className="absolute top-5 right-5">
                  <Badge className="rounded-none border-0 bg-orange-500/90 px-3 py-1 text-xs font-medium uppercase tracking-wide text-white backdrop-blur">
                    Featured
                  </Badge>
                </div>
              )}
            ...
            <div className="space-y-6 px-8 pb-8 pt-6">
              ...
              {project.tech && project.tech.length > 0 && project.tech.slice(0, 1).map((tech) => (
                <Badge
                  key={tech}
